...
def len_refine():
    ...
    with open("../Dataset/normal_len_seq2.fasta", "w") as handle:
...
#extracting 30 random seqs for each family
    ...
    with open("../Dataset/Selected30_families_tcdb2.fasta", "w") as handle:
...
def extract_subfamily_dataset():
    ...
    with open("../Dataset/Selected30_subfamilies_tcdb2.fasta", "w") as handle:
         for rec in selected_list_seqReq:
             SeqIO.write(rec, handle, "fasta")
...
#len_refine()
#extract_family_dataset()
extract_subfamily_dataset()